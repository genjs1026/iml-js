...
var ImlExport = require('./imlexport.js');
...
var Iml = (function() {
  ...
  /**
   * Convert Javascript object to IML.
   * @param Javascript object
   * @returns IML content
   */
  Main.prototype.js2iml = function (content) {
    var imlExport = new ImlExport();
    return imlExport.js2iml(content);
  };
  return Main;
})();
